...
class Concordancehit
{
     ...
     *
     */
    public function SetContext($lang): void
    {
        // $this->orig_id = $orig_id;
        $query = "SELECT token, funct, lemma, pos, morph, tokenid, head, deprel  
            FROM 
            ...
            (
                ...
                WHERE funct != 'tag'";
        $res = pg_query_params($this->con, $query, [$this->orig_id]);
        $this->context = pg_fetch_all($res);
    }
}
